...
function fvLDMz(fLn::AbstractVector{T},v::StepRangeLen,ℓ::Int64,nai::T,uai::T,vthi::T) where{T}
...
# 1D, nai = vthi = 1
function fvLDMz(fLn::AbstractVector{T},v::StepRangeLen,ℓ::Int64,uai::T) where{T}
...
function fvLDMz(fLn::AbstractVector{T},v::AbstractVector{T},ℓ::Int64,uai::T) where{T}
...
# 1D, uai = 0, nai = vthi = 1
function fM(fLn::AbstractVector{T},v::AbstractVector{T}) where{T}
...
function fvLDMz(fLn::AbstractVector{T},vhe::AbstractVector{T},ℓ::Int64,nai::AbstractVector{T},
...
function fvLDMz(fvL::AbstractArray{T,N},v::AbstractVector{T},LM::Int64,uai::T;
...
function fvLDMz(fvL::AbstractArray{T,N},vhe::AbstractVector{T},nvG::Int64,LM::Int64,
...
function fvLDMz(fvL::Vector{Matrix{T}},vhe::Vector{AbstractVector{T}},LM::Vector{Int64},ns::Int64,
...
function fvLDMz(fvL::Vector{Matrix{T}},v::AbstractVector{T},LM::Vector{Int64},ns::Int64,
    nai::Vector{AbstractVector{T}},uai::Vector{AbstractVector{T}},vthi::Vector{AbstractVector{T}};
    L_limit::Int64=25,rel_dfLM::Real=eps0,abs_dfLM::Real=eps0,is_LM1_full::Bool=false) where{T}
...
function fvLDMz!(fvL::Vector{Matrix{T}},vhe::Vector{AbstractVector{T}},nvG::Vector{Int64},
...
function fvLDMz!(fvL::Vector{Matrix{T}},vhe::AbstractVector{T},nvG::Int64,
    LM::Vector{Int64},ns::Int64,nai::Vector{AbstractVector{T}},
    uai::Vector{AbstractVector{T}},vthi::Vector{AbstractVector{T}},nMod::Vector{Int64};
    L_limit::Int64=25,rel_dfLM::Real=eps0,abs_dfLM::Real=eps0,is_LM1_full::Bool=false) where{T}
...
function fvLDMz!(fvL::Vector{Matrix{T}},vhe::Vector{AbstractVector{T}},
...
function fvLDMz!(fvL::Vector{Matrix{T}},vhe::AbstractVector{T},
    LM::Vector{Int64},ns::Int64,uhkL::AbstractVector{T};
    L_limit::Int64=25,rel_dfLM::Real=eps0,abs_dfLM::Real=eps0,is_LM1_full::Bool=false) where{T}
...
# is_LM1_full = true
# 3.5D,  [nMod,nv,LM1,ns]
function fvLDMzfull(fvL::Vector{Matrix{T}},vhe::Vector{AbstractVector{T}},
    LM::Vector{Int64},LM1::Int,ns::Int64,nai::Vector{AbstractVector{T}},
...
function fvLDMzfull(fvL::Vector{Matrix{T}},vhe::AbstractVector{T},
    LM::Vector{Int64},LM1::Int,ns::Int64,nai::Vector{AbstractVector{T}},
    uai::Vector{AbstractVector{T}},vthi::Vector{AbstractVector{T}},nMod::Vector{Int64}) where{T}
...
# 2.5D, [nMod,nv,LM1],     fvL = zeros(T,nvG,L_limit+1)
function fvLDMzfull(fvL::AbstractArray{T,N},vhe::AbstractVector{T},LM1::Int64,
...
# 2D, [nv,LM1], nMod = 1, nai = vthi = 1
function fvLDMzfull(fvL::AbstractArray{T,N},v::AbstractVector{T},LM1::Int64,uai::T) where{T,N}
