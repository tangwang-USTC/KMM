...
"""
  ...
  Outputs:
    naik1,vthik1,nModelk1 = fl0king01_fMNKCnhC!(naik1,vthik1,nModelk1,
...
function fl0king01_fMNKCnhC!(naik1::AbstractVector{T}, vthik1::AbstractVector{T}, nModelk1::Int64,
...
function fl0king01_fMnhCNKC!(naik1::AbstractVector{T}, vthik1::AbstractVector{T}, nModelk1::Int64,
...
# [ite,nMod≥2],    # _NKC → _nhC
function fl0king01_fMnhCNKC00!(naik1::AbstractVector{T}, vthik1::AbstractVector{T}, nModelk1::Int64,
    DnuTh::AbstractVector{T}, Mhck1::Matrix{T}, errMhcop::Matrix{T}, 
    NL_solve::Symbol, rtol_DnuTi::T,NK::Int64,NKmax::Int64,kt::Int64,tk::T,dtk::T; 
    optimizer=Dogleg, factor=QR(), autodiff::Symbol=:central,
    is_Jacobian::Bool=true, show_trace::Bool=false, maxIterKing::Int64=200,
    ...
    if is_converged_nMod
        ...
        ## Checking whether overdetermined, `nModelk1!
        if is_nhnMod_adapt && nModelk1 ≥ NK
            is_nMod_renew, naik1,vthik1,nModelk1 = nMod_update(naik1,vthik1,nModelk1;rtol_DnuTi=rtol_DnuTi)
        else
            is_nMod_renew = false
        end
