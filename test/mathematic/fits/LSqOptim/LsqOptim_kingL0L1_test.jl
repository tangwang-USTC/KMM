...
p_noise_rel = 1e-2      # `p_noise_rel ≤ 1e-3` default. Relative error of the initial guess parameters `p`
                        # 
...
# function king!(out, x; Ml01=[1.0,1.0,0.0], nModel=1)
...
res = fl0king01!(x0,lbs,ubs,Ml01,nModel;optimizer=optimizer,factor=factor,
...
king_g!(Jfit, xfit; nModel=nModel)
