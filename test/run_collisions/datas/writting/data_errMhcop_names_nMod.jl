...
if is_moments_out
    if is_MjMs_max
        ...
        if norm(uai[isp33]) ≤ epsT10
            ...
            datas_errMhcopla[1,1] = copy(t0)
            if nnjM == 2
                datas_errMhcopla_name = ["t", "errMhcop1", "errMhcop2"]
            elseif nnjM == 4
                datas_errMhcopla_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4"]
            elseif nnjM == 6
                datas_errMhcopla_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6"]
            elseif nnjM == 8
                datas_errMhcopla_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6", "errMhcop7", "errMhcop8"]
            elseif nnjM == 10
                datas_errMhcopla_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6", 
        ...
        if norm(uai[isp33]) ≤ epsT10
            ...
            datas_errMhcoplb[1,1] = copy(t0)
            if nnjM == 2
                datas_errMhcoplb_name = ["t", "errMhcop1", "errMhcop2"]
            elseif nnjM == 4
                datas_errMhcoplb_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4"]
            elseif nnjM == 6
                datas_errMhcoplb_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6"]
            elseif nnjM == 8
                datas_errMhcoplb_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6", "errMhcop7", "errMhcop8"]
            elseif nnjM == 10
                datas_errMhcoplb_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6", 
                                     "errMhcop7", "errMhcop8", "errMhcop9", "errMhcop10"]
            elseif nnjM == 12
        ...
        if pstk["ns"] ≥ 3
            ...
            if norm(uai[isp33]) ≤ epsT10
                ...
                datas_errMhcoplc[1,1] = copy(t0)
                if nnjM == 2
                    datas_errMhcoplc_name = ["t", "errMhcop1", "errMhcop2"]
                elseif nnjM == 4
                    datas_errMhcoplc_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4"]
                elseif nnjM == 6
                    datas_errMhcoplc_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6"]
                elseif nnjM == 8
                    datas_errMhcoplc_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6", "errMhcop7", "errMhcop8"]
                elseif nnjM == 10
                    datas_errMhcoplc_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6", 
                                         "errMhcop7", "errMhcop8", "errMhcop9", "errMhcop10"]
                elseif nnjM == 12
            ...
            if pstk["ns"] ≥ 4
                ...
                if norm(uai[isp33]) ≤ epsT10
                    ...
                    datas_errMhcopld[1,1] = copy(t0)
                    if nnjM == 2
                        datas_errMhcopld_name = ["t", "errMhcop1", "errMhcop2"]
                    elseif nnjM == 4
                        datas_errMhcopld_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4"]
                    elseif nnjM == 6
                        datas_errMhcopld_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6"]
                    elseif nnjM == 8
                        datas_errMhcopld_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6", "errMhcop7", "errMhcop8"]
                    elseif nnjM == 10
                        datas_errMhcopld_name = ["t", "errMhcop1", "errMhcop2", "errMhcop3", "errMhcop4", "errMhcop5", "errMhcop6", 
                                             "errMhcop7", "errMhcop8", "errMhcop9", "errMhcop10"]
                    elseif nnjM == 12
